...
colors <- c("I" = "#9C27B0", 
            "Delboeuf"="#F44336", "Ebbinghaus"="#E91E63",
            "Rod-Frame"="#4CAF50", "Rod\nFrame"="#4CAF50", 
            "Vertical-Horizontal"="#FF9800", "Vertical\nHorizontal"="#FF9800",
            "Zöllner"="#FF5722",
            "White"="#616161", 
             "Müller-Lyer" = "#3F51B5", "Müller\n-Lyer" = "#3F51B5",
            "Ponzo" = "#2196F3",
            "Poggendorff"="#795548",
            "Contrast"="#607D8B", 
            "black"="black")
...
```{r message=FALSE, warning=FALSE, cache=cache, eval=FALSE}
r <- correlation(arrange(dfsem, Participant), 
                 arrange(empirical, Participant), 
