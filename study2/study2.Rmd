...
r <- correlation::correlation(
  data = random |> 
    arrange(Participant) |> 
    data_select(select="Delboeuf", regex=TRUE),
  data2 = empirical |>
    filter(Illusion_Type %in% c("Delboeuf")) |> 
    pivot_wider(names_from = c("Illusion_Type"), values_from = c("Error", "RT_Mean", "RT_SD")) |> 
    arrange(Participant)
  )
