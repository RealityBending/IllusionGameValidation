...
abstract: |
  Visual illusions strikingly highlight how the brain uses contextual and prior information to inform our perception of reality. Unfortunately, illusion research has been hampered by the difficulty of adapting these stimuli to experimental settings, which ideally require a controlled and gradual modulation of the effects of interest. In this set of studies, we used the parametric framework for visual illusions implemented in the *Pyllusion* software to generate 10 different classic illusions (Delboeuf, Ebbinghaus, Rod and Frame, Vertical-Horizontal, Zöllner, White, Müller-Lyer, Ponzo, Poggendorff, Contrast) varying in strength. We tested the objective effect of the illusions on errors and reaction times in a perceptual discrimination task. We then extracted the participant-level performance scores (n=250), and provide evidence in favour of the existence of a general factor (labelled Factor *i*) underlying the sensitivity to different illusions. Finally, we report a positive relationship between illusion sensitivity and personality traits such as Agreeableness, Honesty-Humility, and negative relationships with Psychoticism, Antagonism, Negative Affect and Disinhibition. All the materials are available in open-access (https://github.com/RealityBending/IllusionGameValidation). We invite researchers to re-analyze the data using alternative approaches to provide complimentary findings on the effect, structure and correlates, of illusion sensitivity.
...
Study 3 aimed at investigating the links between the inter-individual scores of illusion sensitivity (obtained in study 2), and demographic and dispositional variables. Despite the abundant literature on visual illusions, relatively few studies have investigated its ties with participants' characteristics. Moreover, research examining the influence of demographic variables tend to be centered on gender and age-related differences, and have generally found inconsistent results [@cretenoud2020a; @grzeczkowski2017; @lo2011; @papageorgiou2020]. Alternatively, among works assessing the links with personality, most focused on traits associated with psychopathology [such as impulsivity or sensation-seeking, @hlavata2018; @zhang2017; @lanyi2022can; @pessoa2008]. In this study, we instead propose to explore the relationship between illusion sensitivity, demographic variables and stable "general" personality traits.
...
Contrary to past studies in which females were found to exhibit greater illusion sensitivity [@lo2011; @miller2001; @papageorgiou2020], our study finds males to be more sensitive to the effects of the Zollner illusion. This inconsistency in findings could be due to past results conflating the objective illusory effect with the subjective perceptual skills needed to evaluate the visual illusions. Indeed, gender-related differences in visuospatial strategies have often been cited as the underlying mechanism explaining greater illusion sensitivity among females [@miller2001; @lo2011]. In this study, however, individuals' perceptual abilities and the objective illusory effect were independently modulated using our *Pyllusion* software. This thus allowed us to capture the variability related only to the latter, thereby mitigating the effects of subjective perceptual skills. As such, the greater illusion sensitivity among males observed (albeit only for the Zollner illusion) could be a more veridical reflection of the illusion effect.

<!-- Normal personality -->

Our findings also suggested a positive relationship between illusion sensitivity and two "normal" personality traits, namely *Honesty-Humility* and *Agreeableness*. Although the past literature regarding the links between illusion sensitivity and personality traits remain scarce, convergent evidence can be found in studies reporting a negative relationship between illusion sensitivity and hostility, aggression and narcissism [@zhang2017; @konrath2009seeing]. One possible explanation for this association could be drawn from the literature on field dependence, which states that individuals with a field dependent cognitive style are more reliant on external cues when faced with ambiguity [@witkin1976]. Since personality traits such as narcissism and aggression have been correlated with relative field independence [@ohmann2016; @witkin1976a; @damour2021], this implies that individuals with high levels of such traits may be less reliant on biasing visual cues and thus display less illusion sensitivity.

<!-- Pathological personality -->

The positive relationship between illusion sensitivity and "positive" personality traits is mirrored by a negative relationship with several pathological traits, including *Antagonism*, *Psychoticism*, *Disinhibition*, and *Negative Affect*. These results are, in general, consistent with past findings and theories, suggesting a potential negative correlation between egocentric cognitions and context processing. Specifically, pathological egocentric beliefs, which is indexed by high levels of self-focus (and low levels of other-focus) and have been related to maladaptive personality traits like *Psychoticism,* could be associated with a reduced consideration for context integration, such as a tendency to disembed objects from their surroundings when processing visual stimuli [@ohmann2016; @konrath2009; @fox2006]. This could hence explain the positive relationship between illusion sensitivity and pathological traits observed in our study. Indeed, high levels of self-focus have been found to correlate with lower illusion sensitivity [@konrath2009], conferring support for the postulated links between egocentrism and decontextualized information processing.

Furthermore, our results, which suggests the existence of a link between illusion sensitivity and maladaptive personality traits in non-clinical populations, could be put in relation with clinical findings, which could be seen as extreme cases where the relationship with illusion sensitivity most manifests. In line with our results on *Psychoticism* or *Disinhibition*, prior research has found greater illusion resistance in schizophrenia [@notredame2014; @pessoa2008; @grzeczkowski2018], and in particular, in association with schizotypal traits, such as cognitive disorganization [@cretenoud2019; @lanyi2022can].

<!-- The results reported by past studies on the relationship between illusion sensitivity and personality remain fairly mixed [@cretenoud2020a; @grzeczkowski2017].  -->

<!-- Moreover, low aggression and high self-control have also been found to correlate strongly with greater resistance to illusions [@mcgurk]. -->

# General Discussion

<!-- Parametric framework -->

The parametric illusion generation framework that we have developed in @makowski2021 proposes to conceptualize illusions as made of targets and distractors, both of which can be manipulated independently and continuously. In the present study, we have shown that such gradual modulation of illusion strength is effectively possible across 10 different types of classic visual illusions. This important methodological step opens the door for new illusions-based paradigms and tasks, to study the effect of illusions under different conditions and to quantify illusion sensitivity using objective behavioral outcomes, such as accuracy or speed.

<!-- Factor i -->

Our findings suggested that the participants' sensitivities to 10 different types of visual illusions shared a common part of variance, suggesting the existence of a general factor of illusion sensitivity (Factor *i*). This result comes in a field of mixed findings. In fact, contrary to early studies on visual illusions, recent research (over the past 10 years) have generally not found any significant evidence for a common stable factor across illusions within individuals [@grzeczkowski2017; @cretenoud2019; @cretenoud2020; @grzeczkowski2018; @yang2012]. Instead, past findings suggests illusory effects are highly specific to the features of different illusions, albeit some attempts at grouping certain illusions in hopes of extracting a common generalizable factor have been made [@grzeczkowski2017; @cretenoud2019]. However, the absence of significant results could have been due to the reliance of conventional paradigms, in which participants were instructed to adjust targets to be aligned with a reference stimulus. As such paradigms depend upon participants' subjective perceptual skills, our study hence provides a possible objective framework that could culminate in a renewed approach into the field of visual illusions.

Furthermore, although the illusions we assessed were fairly different in terms of the perceptual task involved (contrast-based, size-estimation, angle-perception), the possibility of our general factor being driven by inter-individual perceptual skills variability cannot be discarded. Future studies should investigate the relationship between perceptual abilities (in a similar task, but without illusions) and illusion sensitivity.

<!-- Personality -->

Notably, the general sensitivity to illusions Factor *i* was negatively associated with *Antagonism*, *Psychoticism*, *Disinhibition* and *Negative Affect*.
...
<!-- Despite the widespread interest in finding associations between personality correlates and a general sensitivity to visual illusions, the supporting literature remains relatively mixed. Whereas some researchers report no relationship between inter-individual traits and individuals' susceptibility to illusions [@cretenoud2020a; @grzeczkowski2017], others have found pathological traits such as higher Aggression-Hostility and Narcissism, and lower Impulsive Sensation-Seeking to be significantly correlated to a greater resistance against such illusory effects [@zhang2017; @konrath2009seeing]. Furthermore, research on patients with schizophrenia have also generally demonstrated lower illusion sensitivity to be linked to symptoms of the disorder, such as greater hostility as well as social and emotional withdrawal [@pessoa2008]. -->
...
Future study should investigate the psychometric properties of similar paradigms, including stability (e.g., test-retest reliability), consistency (in particular, the relationship with perceptual abilities), and validity.
