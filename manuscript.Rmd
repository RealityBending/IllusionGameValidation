...
```{r message=FALSE, warning=FALSE, fig.cap="The upper plots show the distribution of demographic and dispositional variables. The middle plots show the relationship between illusion sensitivity scores, sex, and age (solid lines indicate significant relationships). Bottom plots show the correlation between the general factor of illusion sensitivity (Factor \\textit{i}), and personality traits.", out.width="100%"}
