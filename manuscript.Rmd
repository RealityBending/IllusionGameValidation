...
Notably, the presence of a common mechanism underlying the effect of different illusions has been contested [@hamburger2016; @cretenoud2019a; @teufel2018a; @cretenoud2020]; and the nature of the underlying processes - whether related to low-level features of the visual processing system [@cretenoud2019; @gori2016] or to top-down influences of prior beliefs [@teufel2018; @caporuscio2022] are strongly debated. The existence of dispositional or demographic correlates of illusion sensitivity - for example, higher illusion resistance has been reported in schizophrenia and autism [@notredame2014; @park2022; @giaouri2011; @keane2014]; as well as for individuals with lower trait anxiety [@zhang2017; @qadri2020; @baroun2005] - is another area of controversy.
...
Study 3 aimed at investigating the links between the inter-individual scores of illusion sensitivity (obtained in study 2), and demographic and dispositional variables. Despite the abundance of literature on visual illusions, relatively few researchers have attempted to examine the ties between demographic variables and personality traits with regard to individuals' resistance to illusions. Furthermore, most studies that focused on personality differences in illusion response primarily investigated the effects of traits associated with schizophrenia and autism spectrum disorders (such as impulsivity and sensation-seeking etc; [@hlavatá2018; @zhang2017; @lanyi2022can; @pessoa2008]). In this study, we instead aim to further elucidate inter-individual susceptibility to illusory effects by delineating the relationship between illusion susceptibility and demographic (i.e., age and gender) and dispositional components.
...
Interestingly, screen size was found to have a significant negative effect on illusion sensitivity for the White and Contrast illusions. This could be a result of our visual systems filtering through more low spatial frequency content when the size of the target object is small [@dixon2014]. As this filtering process excludes illumination information from visual processing, smaller screen sizes could result in an unprecedented change in brightness perception. As such, this could attenuate the illusory effect of the White and Contrast illusions, decreasing participants' susceptibility to the illusions since the illusory effects of both are dependent on luminance.

Although the present literature regarding the effects of personality correlates on illusion susceptibility remains fairly mixed [@cretenoud2020a; @grzeczkowski2017; @zhang2017; @ohmann2016], this study provides evidence of a positive relationship between illusion sensitivity and multiple personality traits, such as *Honesty-Humility* and *Agreeableness,* in healthy populations. Notably, higher scores in "pathological" traits such as *Antagonism, Psychoticism, Disinhibition* as well as *Negative Affect* were strongly correlated with lower illusion sensitivity (Factor *i*). This observation is consistent with past studies, in which higher self-reported Aggression-Hostility and Narcissism scores were associated with lower susceptibility to illusions [@zhang2017; @ohmann2016]. Moreover, low aggression and high self-control have also been found to correlate strongly with greater resistance to illusions [@mcgurk], conferring further support for the results we observed. As such, while the effects of personality on illusion sensitivity have typically only been found among clinical populations (usually in association with schizotypal traits, such as cognitive disorganization [@cretenoud2019]), this study demonstrates that differences in personality traits can also lead to inter-individual variation in illusion susceptibility. Further studies are required to replicate the observed findings and validate the underlying effects of personality dimensions on illusion susceptibility.

# General Discussion

Using the parametric illusion generation framework developed with *Pyllusion* [@makowski2021], we have hence shown that illusions can be manipulated continuously across several different visual illusions. This opens the door for new illusions-based paradigms and tasks, therefore making it possible for future researchers to directly manipulate specific features and parameters of the illusion that are of interest. The validation of this novel framework also affords future illusion scientists a standardized measure of illusion susceptibility, instead of relying on conventional methods that depend upon participants' subjective perceptions. In our paradigm, in which we apply this approach to a reaction-time task, we were able to measure inter-individual scores of objective illusion sensitivity.
