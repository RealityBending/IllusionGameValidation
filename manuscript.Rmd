...
<!-- Demographic -->
**TODO: talk about absence of effect on sex + effect on age**

<!-- Normal personality -->
Our findings also suggested a positive relationship between illusion sensitivity and two "normal" personality traits, namely *Honesty-Humility* and *Agreeableness*. Although the past literature regarding the links between illusion sensitivity and Big 5 or HEXACO personality traits remain scarce, convergent evidence can be found in studies reporting a negative relationship between illusion sensitivity and hostility, aggression and narcissism [@zhang2017; @konrath2009seeing]. **TODO: do we have any leads of explanations?**


<!-- Pathological personality -->
The positive relationship between illusion sensitivity and "positive" personality traits is mirrored by a negative relationship with several pathological traits, including *Antagonism*, *Psychoticism*, *Disinhibition*, and *Negative Affect*. These results are in general consistent with the past findings and theories, suggesting that ...**TODO: do we have a theory?**


Our results, suggesting the existence of a link between illusion sensitivity and maladaptive personality traits in non-clinical populations, could be put in relation with clinical findings, which could be extreme cases where the relationship with illusion sensitivity is the most manifest. In line with our results on *Psychoticism* or *Disinhibition*, prior research has found greater illusion resistance in schizophrenia [**REF**], and in particular in association with schizotypal traits, such as cognitive disorganization [@cretenoud2019]. 
