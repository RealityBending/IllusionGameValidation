...
Notably, the presence of a common mechanism underlying the effect of different illusions has been contested [@hamburger2016; @cretenoud2019a; @teufel2018a; @cretenoud2020]; and the nature of the underlying processes - whether related to low-level features of the visual processing system [@cretenoud2019; @gori2016] or to top-down influences of prior beliefs [@teufel2018; @caporuscio2022] are strongly debated. The existence of dispositional or demographic correlates of illusion sensitivity - for example, higher illusion resistance has been reported in schizophrenia and autism [@notredame2014; @park2022; @giaouri2011; @keane2014]; as well as in males as compared to females [@miller2001; @papageorgiou2020; @lo2011; @shaqiri2018] - is another area of controversy.
...
Study 3 aimed at investigating the links between the inter-individual scores of illusion sensitivity (obtained in study 2), and demographic and dispositional variables. **Insert a bit of litterature about why and some findings justifying what we did**.
