...
Study 3 aimed at investigating the links between the inter-individual scores of illusion sensitivity (obtained in study 2), and demographic and dispositional variables. \textbf{Insert a bit of litterature about why and some findings justifying what we did}.
...
\begin{figure}
\includegraphics[width=9.33in]{figures/Figure3} \caption{CAPTION.}\label{fig:unnamed-chunk-4}
\end{figure}
