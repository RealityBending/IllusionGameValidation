...
In the present set of studies, we will first test this novel paradigm by investigate if the effect of illusion can be manipulated continuously. Then, we will use it to assess whether 10 different illusions share a common latent factor (a long-standing debate), 3) how the the inter-individual sensitivity to illusions relates to other characteristics, such as sex or personality.
