...
<!-- [based on the Bayes Factor *BF* or the Probability of Direction *pd*, see @makowski2019indices].  -->
(based on the Bayes Factor *BF* or the Probability of Direction *pd* [@makowski2019indices]).
...
<!-- See study 1 documentation (Part 2 - Discussion) in the GitHub repository [**https://github.com/RealityBending/IllusionGameValidation**](https://github.com/RealityBending/IllusionGameValidation){.uri} for a detailed discussion regarding these associations.  -->
