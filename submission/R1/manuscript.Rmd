...
```{r message=FALSE, warning=FALSE, fig.cap="The upper plots show the illusion sensitivity scores as a function of sex and age (solid lines indicate significant relationships). Bottom plots show the correlation between the general factor (Factor \\textit{i}) of illusion sensitivity (on the x-axes) and personality traits.", out.width="100%"}
