...
Notably, the presence of a common mechanism underlying the effects of different illusions has been contested [@hamburger2016; @cretenoud2019; @cretenoud2020illusions]. Indeed, while early research had suggested a common factor of illusion sensitivity indexed by overall vision proficiency [@halpern1999interindividual; @thurstone1944factorial], recent studies attempting to identify said factor have at most observed weak correlations between resistance to distinct illusions [@grzeczkowski2017; @grzeczkowski2018]. To this end, the nature of the processes underlying illusion perception - whether related to low-level features of the visual processing system [@cretenoud2019; @gori2016] or to top-down influences of prior beliefs [@teufel2018; @caporuscio2022] remain debated. To add, the existence of dispositional correlates of illusion sensitivity has also been another area of controversy, with some studies reporting higher illusion resistance in individuals with stronger aggression and narcissism traits [@zhang2017; @konrath2009seeing]. In particular, an increasing amount of evidence in recent years purports lower illusion susceptibility in patients with schizophrenia and autism [@notredame2014; @park2022; @grzeczkowski2018; @gori2016; @razeghi2022].   

<!-- Bayes -->

In an attempt to bridge the research gaps aforementioned, one recent theory proposes to conceptualize illusions under the Bayesian brain hypothesis [@friston2010free]; as ambiguous percepts (noisy sensory evidence) giving ample weight to prior knowledge to provide a coherent perceptual experience. In this framework, certain traits or characteristics (e.g., psychoticism) are driven by alterations in the system's metacognitive components [@adams2013computational], resulting in underweighting of priors during perceptual inferences, and manifesting as a decreased sensitivity to illusions [@koethe2009binocular]. 

<!-- Technical issues -->

Despite strong theoretical foundations and hypotheses, the empirical evidence remains scarce, clouded by methodological hurdles. For instance, one key challenge to empirical efforts involves the difficulty of adapting visual illusions to an experimental setting, which typically requires the controlled modulation of the specific variables of interest. Instead, existing studies typically use only one or a small subset of illusion types, with few contrasting conditions, restricting the findings' generalizability [@cretenoud2020illusions; @cretenoud2019z; @bressan2021most]. Moreover, conventional paradigms often focus on the participants' subjective experience, by asking them the extent to which they perceive two identical targets as different [@lanyi2022can], or having them adjust the targets to perceptually match a reference stimulus [@mylniec2016; @grzeczkowski2018]. However, this reliance on meta-cognitive judgements about one's subjective experience likely distorts the measurand, limiting the ability to reliably obtain more direct and objective measures of illusion sensitivity [@skottun2014subjective].
